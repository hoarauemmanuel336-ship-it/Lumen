/* ============================================================
   ...
   et Mémoriser (/memoriser.html). Le CSS vient de index__48_.html.
   ============================================================ */
const fs = require('fs');
...
const UI = {
  fr: {
    ...
    memo_label:"L'outil", memo_title:'Mémoriser', memo_open:'Ouvrir Mémoriser', memo_start:'Commencer', memo_mastery:'de maîtrise', memo_acquired:'acquis', memo_learning:'en cours', memo_review:'à revoir', memo_signedout:'Connectez-vous pour suivre votre progression.',
  }
};
...
{
  const surfaces = ['index.html', 'bible.html', 'memoriser.html', '404.html'];
  ...
  console.log('Barres : identiques sur les ' + surfaces.length + ' surfaces');
}
